...
class _HomePageState extends State<HomePage> {
  ...
  //Shedule
  Schedule schedule =
      Schedule(date: 0, name: '-', description: '-', piket1: '-', piket2: '-');
      ...
      http.Response response =
          await http.post(Uri.parse('https://fcm.googleapis.com/fcm/send'),
              headers: <String, String>{
                ...
                'Authorization':
                    'key=AAAAyCmUOOA:APA91bFUJFdIt7DAF_qkh7oHC2uqW954-HTTPmnP2VecGNlM6lj7UgaRr3OiT4ZR58Z0EecOW3OGkSOoWWnq4h8AERYssrGT-J00jnqLIAFfOfp_QnbwI7_XTjoHtlcDysL7oY19DGyh'
              },
              body: jsonEncode(<String, dynamic>{
                ...
                'data': data,
                'to':
                    'd-Mpc7oqRPmNcXdXtkh2up:APA91bGztCM594GjJeVVPPF0RW4cVuIuf89OeZxNePIX2XQY84o_G4zBMqBVtqt4vU_0uMBCCeD7tzvBxwaUJtfawWWfYwkKoalp3imd-1br5umKC4c8yi1evBKzOa42Lh3rliJuVheR'
              }));
      print(response.body);
                            ...
                            Row(
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    if (!isActiveNotif) {
                                      await scheduleWorkTime(
                                          0,
                                          'Waktunya Jam Pulang',
                                          'Jangan lupa klik jam pulang ya $nama',
                                          Time(16, 00));
                                      setState(() {
                                            ...
                                            children: [
                                              Container(
                                                  child: Text(schedule.name,
                                                      style: mStyleSubTitle)),
                                              Container(
                                                  child: Text(schedule.piket1,
                                                      style: mStyleSubTitle)),
                                            ],
                                          ),
                                        ),
